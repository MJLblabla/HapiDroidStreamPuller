### 依赖
```
 implementation project(':hapiAVPackerClinet') //client -> 采集 编码模块 必须依赖 //也可以单独  采集':hapiAVCapture'/':HapiAVEncoder'
    //可选模块
    implementation project(':hapiAVRender') //预览模块 视频 音频 本地回显 可选
